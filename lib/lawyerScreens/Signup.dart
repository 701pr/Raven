...
class Lsignup extends StatefulWidget {
  const Lsignup({Key? key}) : super(key: key);

  @override
  _LsignupState createState() => _LsignupState();
}

class _LsignupState extends State<Lsignup> {
  ...
  postDetailsToFirestore() async {
    ...
    userModel.email = lawyer!.email;
    userModel.uid = lawyer.uid;
